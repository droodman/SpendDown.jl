...
```
5. The frontend should appear in a new browser tab.
6. Especially on first use, wait a long time for the needed packages to download and compile.
...
`src/SpendDown.jl` is the main codebase.
...
`src/frontend.jl` is the Pluto front end.
